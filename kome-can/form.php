    ...
    <div class="form-container">
        ...
        <form action="confirm.php" method="POST">
                ...
                <div class="item-select-group">
                    <label class="item-select-label">
                        ...
                        <div class="item-card-content">
                            ...
                            <div class="item-info">
                                <span class="item-name">6個セット <small>一人暮らしの備えや、まず試してみたい方におすすめ</small></span>
                    ...
                    <label class="item-select-label">
                        ...
                        <div class="item-card-content">
                            <span class="radio-mark"></span>
                            <div class="item-info">
                                <span class="item-name">12個セット <small>ご家庭の備えにちょうどいい安心のセット</small></span>
                    ...
                    <label class="item-select-label">
                        ...
                        <div class="item-card-content">
                            <span class="radio-mark"></span>
                            <div class="item-info">
                                <span class="item-name">24個セット <small>しっかり備えておきたい方や家族用の本格備蓄セット</small></span>
            ...
            <div class="form-group">
                ...
                <div class="item-select-group">
                    <label class="item-select-label">
                        <input type="radio" name="payment_method" value="credit" <?php echo (($data['payment_method'] ?? 'credit') === 'credit') ? 'checked' : ''; ?>>
                        <div class="item-card-content" style="padding: 15px 20px;">
                            <span class="radio-mark"></span>
                            <div class="item-info">
                                <span class="item-name">クレジットカード決済</span>
                            </div>
                        </div>
                    </label>
                    <label class="item-select-label">
                        <input type="radio" name="payment_method" value="bank" <?php echo (($data['payment_method'] ?? '') === 'bank') ? 'checked' : ''; ?>>
                        <div class="item-card-content" style="padding: 15px 20px;">
                            <span class="radio-mark"></span>
                            <div class="item-info">
                                <span class="item-name">銀行振込</span>
                            </div>
                        </div>
                    </label>
                </div>
            ...
            <div style="background: #fff9f0; border: 1px solid #f9dab3; padding: 20px; border-radius: 8px; margin-top: 30px; font-size: 0.9rem; line-height: 1.6;">
                <p style="color: #d37b00; font-weight: bold; margin-bottom: 5px;">【配送に関する重要なお知らせ】</p>
                <p style="color: #5d4a35; margin: 0;">
                    3月11日のリリースは「予約受付開始」となります。商品の発送は<strong>2026年5月から順次配送</strong>を予定しております。お届けまでにお時間を頂戴いたしますが、あらかじめご了承の上、お申し込みください。
                </p>
            </div>
